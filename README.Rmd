...
Next, point to a directory containing `.csv` data that has been previously exported using the script `datavyu2csv.rb`. The example below uses the internal package data directory for demonstration purposes.
