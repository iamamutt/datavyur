...
For example, you may have several files with multiple "columns" in each file, and in each column have the standard `onset`, `offset`, and `ordinal` fields, along with custom codes that hold values.
...
This is a basic example which shows you how to import Datavyu data into R.
